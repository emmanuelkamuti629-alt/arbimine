...
// ==================== Exchange scanning ====================
// (Keep your existing exchange code here – omitted for brevity)
// ============================================================
...
// (Place your existing /api/opportunities and /api/opportunity/:id/details here)
// ============================================================
...
app.get('/api/payment/callback', async (req, res) => {
  ...
  console.log(`🔔 Callback received with reference: ${reference}`);
  if (!reference) {
...
// TEMPORARY GET route to verify webhook endpoint is reachable
app.get('/api/payment/webhook', (req, res) => {
  res.send('✅ Webhook endpoint is live.');
});

// Webhook with signature verification (POST)
