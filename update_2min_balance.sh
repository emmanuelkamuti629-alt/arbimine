#!/bin/bash
# Update refresh to 2 min and fix balance display for both exchanges

echo "🔄 Backing up current files..."
cp server.js server.js.bak2
cp public/index.html public/index.html.bak2

echo "📝 Updating server.js (refresh interval + balance route)..."
cat > server.js << 'EOF'
...
echo "📝 Updating public/index.html (balance display for both exchanges)..."
...
echo "✅ All changes applied. Backups saved as .bak2"
